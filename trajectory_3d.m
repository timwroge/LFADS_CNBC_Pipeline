...
dataset_name = strcat(full_file_path , '/hyperparameter/data/datasets/', instance, '.mat');
...
if (exist('dc', 'var') & PRELOAD_DATA)
    ...
    ds = CNBCPipeline.Dataset(dc, instance); % adds this dataset to the collectio
...
%parSet = par.generateSweep('c_factors_dim', [3]);
...
run1 = rc.findRuns(runName, 'param_EkvHy4');
...
disp('Saving figure' )
savefig('3d_traj_11_no_start.fig');
disp('Figure saved' )
